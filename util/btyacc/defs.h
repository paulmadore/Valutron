...
#define BIT(r, n)                                                              \
    ((((r)[(n) / BITS_PER_WORD]) >> ((n) & (BITS_PER_WORD - 1))) & 1)
#define SETBIT(r, n)                                                           \
    ((r)[(n) / BITS_PER_WORD] |= ((unsigned)1 << ((n) & (BITS_PER_WORD - 1))))
...
#define TREALLOC(t, p, n)                                                      \
    ((t *)realloc ((char *)(p), (size_t) (n) * sizeof (t)))
...
extern void destructor_redeclared_warning (int a_lineno, char * a_line,
                                           char * a_cptr);
extern void dollar_error (int a_lineno, char * a_line,
                          char * a_cptr) GCC_NORETURN;
extern void dollar_warning (int a_lineno, int i);
extern void fatal (const char * msg) GCC_NORETURN;
extern void illegal_character (char * c_cptr) GCC_NORETURN;
extern void illegal_tag (int t_lineno, char * t_line,
                         char * t_cptr) GCC_NORETURN;
...
extern void syntax_error (int st_lineno, char * st_line,
                          char * st_cptr) GCC_NORETURN;
...
extern void unterminated_action (int a_lineno, char * a_line,
                                 char * a_cptr) GCC_NORETURN;
extern void unterminated_comment (int c_lineno, char * c_line,
                                  char * c_cptr) GCC_NORETURN;
extern void unterminated_string (int s_lineno, char * s_line,
                                 char * s_cptr) GCC_NORETURN;
extern void unterminated_text (int t_lineno, char * t_line,
                               char * t_cptr) GCC_NORETURN;
extern void unterminated_union (int u_lineno, char * u_line,
                                char * u_cptr) GCC_NORETURN;
extern void untyped_arg_warning (int a_lineno, const char * dlr_opt,
                                 const char * a_name);
...
extern void unterminated_arglist (int a_lineno, char * a_line,
                                  char * a_cptr) GCC_NORETURN;
...
#define mputc(m, ch)                                                           \
    (((m)->ptr == (m)->end) ? mputchar (m, ch) : (*(m)->ptr++ = (char)(ch)))
