...
static void print_pos (const char * st_line, const char * st_cptr)
{
    const char * s;
...
#if !defined(YYBTYACC)
void unsupported_flag_warning (const char * flag, const char * details)
{
...
void at_error (int a_lineno, char * a_line, char * a_cptr)
{
    fprintf (stderr, "%s: e - line %d of \"%s\", illegal @$ or @N reference\n",
             myname, a_lineno, input_file_name);
    print_pos (a_line, a_cptr);
    done (1);
}

void unterminated_arglist (int a_lineno, char * a_line, char * a_cptr)
{
    fprintf (stderr, "%s: e - line %d of \"%s\", unterminated argument list\n",
             myname, a_lineno, input_file_name);
    print_pos (a_line, a_cptr);
    done (1);
}

void arg_number_disagree_warning (int a_lineno, char * a_name)
{
...
void arg_type_disagree_warning (int a_lineno, int i, char * a_name)
{
...
void unknown_arg_warning (int d_lineno, const char * dlr_opt,
...
void untyped_arg_warning (int a_lineno, const char * dlr_opt,
                          const char * a_name)
{
...
void wrong_number_args_warning (const char * which, const char * a_name)
{
    fprintf (stderr,
...
void wrong_type_for_arg_warning (int i, char * a_name)
{
    fprintf (
        stderr,
...
void start_requires_args (char * a_name)
{
    fprintf (stderr,
...
void destructor_redeclared_warning (int a_lineno, char * a_line, char * a_cptr)
{
